...
backup = path.with_suffix(".tsx.bak-hero-balanced-safe-" + datetime.now().strftime("%Y%m%d-%H%M%S"))
...
function HeroSection({
  ...
  return (
    <header className="relative mb-6 overflow-hidden rounded-[1.75rem] border border-cyan-200/70 bg-sky-950 text-white shadow-[0_18px_50px_rgba(12,74,110,0.22)]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_22%,rgba(34,211,238,0.24),transparent_25%),radial-gradient(circle_at_12%_88%,rgba(14,165,233,0.14),transparent_28%),linear-gradient(135deg,#082f49_0%,#0f172a_48%,#0e7490_100%)]" />
      <div className="absolute right-8 top-8 h-2 w-2 rounded-full bg-cyan-300 shadow-[0_0_18px_rgba(103,232,249,0.9)]" />

      <div className="relative grid gap-8 p-5 lg:grid-cols-[0.88fr_0.88fr] lg:items-center lg:p-7">
        <div className="min-w-0">
          ...
          <h1 className="max-w-xl text-3xl font-black tracking-tight text-white sm:text-4xl lg:text-[2.55rem]">
          ...
          <p className="mt-4 max-w-lg text-sm leading-6 text-sky-100/70">
        ...
        <div className="relative">
          <div className="absolute -right-8 -top-8 h-40 w-40 rounded-full bg-emerald-300/18 blur-3xl" />
          <div className="absolute -bottom-10 left-8 h-32 w-32 rounded-full bg-cyan-300/18 blur-3xl" />

          <div className="relative overflow-hidden rounded-[1.5rem] border border-cyan-100/35 bg-white/12 p-5 shadow-[0_22px_65px_rgba(0,0,0,0.26)] ring-1 ring-cyan-200/15 backdrop-blur">
            <div className="absolute right-0 top-0 h-24 w-24 rounded-bl-full bg-cyan-300/14" />
            ...
            <div className="relative">
              ...
              <h2 className="max-w-md leading-tight">
...
print("✅ Hero réparé avec Try & Buy équilibré")
