          ...
          <div className="bg-white rounded-2xl border border-brand-100 p-8 lg:p-10">
            ...
            <div className="text-center py-12">
                ...
                <p className="text-brand-900/70">
                  Notre équipe vous répondra sous 4h ouvrées.
                </p>
              </div> :
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-xl border border-brand-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 outline-none transition bg-white">
                    <option>Demande de devis</option>
                    <option>Audit de parc IT</option>
                    <option>Question SAV</option>
                    <option>Reprise de matériel</option>
                    <option>Autre</option>
                  </select>
                </div>
                <div>
                ...
                <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 bg-brand-700 hover:bg-brand-800 text-white px-7 py-4 rounded-xl text-base font-medium transition-all shadow-lg shadow-brand-900/20">
