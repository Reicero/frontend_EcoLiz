...
function normalizeBrand(value) {
  ...
  const keyboardLanguageOverrides = [
    { match: ["no keyboard", "without keyboard", "sans clavier"], label: "" },

    { match: ["french canadian", "canadian french"], label: "Français canadien" },
    { match: ["french stickey", "french sticky", "french", "francais", "français"], label: "AZERTY FR" },
    { match: ["belgian", "belgique", "belge"], label: "AZERTY BE" },

    { match: ["german", "deutsch"], label: "QWERTZ DE" },
    { match: ["swiss", "suisse", "schweiz"], label: "QWERTZ CH" },

    { match: ["us/arabic", "us arabic"], label: "QWERTY US / Arabe" },
    { match: ["us/greek", "us greek"], label: "QWERTY US / Grec" },
    { match: ["us or us int", "us int", "us international", "united states", "american"], label: "QWERTY US" },

    { match: ["uk", "united kingdom", "british"], label: "QWERTY UK" },
    { match: ["qwerty international", "english int", "english international", "international layout"], label: "QWERTY international" },

    { match: ["spanish latin america"], label: "Espagnol LATAM" },
    { match: ["spanish", "espagnol", "espanol"], label: "Espagnol" },
    { match: ["italian", "italien"], label: "Italien" },
    { match: ["portuguese", "portugais"], label: "Portugais" },

    { match: ["nordic", "nordique"], label: "Nordique" },
    { match: ["danish", "danois"], label: "Danois" },
    { match: ["swedish", "suedois", "suédois"], label: "Suédois" },
    { match: ["norwegian", "norvegien", "norvégien"], label: "Norvégien" },

    { match: ["czech/slovak", "czech slovak"], label: "Tchèque / Slovaque" },
    { match: ["czech", "tcheque", "tchèque"], label: "Tchèque" },
    { match: ["slovenian", "slovene", "slovène"], label: "Slovène" },
    { match: ["polish", "polonais"], label: "Polonais" },
    { match: ["hungarian", "hongrois"], label: "Hongrois" },
    { match: ["turkish", "turc"], label: "Turc" },
    { match: ["greek", "grec"], label: "Grec" },
    { match: ["hebrew", "hebreu", "hébreu"], label: "Hébreu" },
    { match: ["arabic", "arabe"], label: "Arabe" },

    { match: ["south african"], label: "QWERTY ZA" },
    { match: ["other"], label: "Autre" },
  ];

  for (const entry of keyboardLanguageOverrides) {
    if (entry.match.some((value) => text.includes(value))) {
      return entry.label;
    }
  }
...
function inferKeyboardLanguageFromText(...values) {
  const text = normalizeText(values.filter(Boolean).join(" "));

  if (!text) return "";

  const keyboardRelated =
    text.includes("keyboard") ||
    text.includes("clavier") ||
    text.includes("type cover") ||
...
function extractFilterValues({ row, product, apiProduct }) {
  ...
  const keyboardLanguage = normalizeKeyboardLanguage(keyboardLanguageSource);
